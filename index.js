...
async function getTweetsAndInsertHTML() {
    ...
    document.getElementById('root').insertAdjacentHTML('beforeend', tweets.data.map((tweet) => {
        ...
        return `<div id=${tweet._id} class="tweets">
            ...
            <div class="tweet-header">
                ...
                <p><strong>Mansi Chavan</strong></p>
                <p>@mansichavan</p>
...
document.addEventListener('click', async (event) => {
    if(event.target.classList.contains('twt')) {
        const tweetText = document.querySelector('.input').value;
